...
export const AIMentorChat = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hi! I'm your AI Language Mentor! 🌟 I'm here to help you learn and practice languages. Ask me anything about grammar, vocabulary, or try practicing conversations with me!",
    },
  ]);
    ...
    try {
      ...
      const response = await fetch(CHAT_URL, {
        ...
        body: JSON.stringify({
          ...
          language: languageInfo?.name || 'general language',
        }),
      });
